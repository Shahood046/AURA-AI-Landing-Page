...
export function EOAnalystSection() {
  return (
    <SectionWrapper
      ...
      title="Earth Observation Analyst"
      description="Perform no-code multi-spectral analysis on Sentinel-2, Landsat, and MODIS datasets. Select regions, calculate vegetation indexes (NDVI, EVI), and generate custom charts with Google Earth Engine pipelines."
      accentColor="#2dd4bf"
    >
      <button className="group px-6 py-3 text-sm font-medium text-white font-body rounded-full border border-white/20 hover:border-white/50 hover:bg-white hover:text-black transition-all duration-300 flex items-center gap-2 cursor-pointer bg-white/5 backdrop-blur-sm">
        <span>Open EO Analyst Console</span>
